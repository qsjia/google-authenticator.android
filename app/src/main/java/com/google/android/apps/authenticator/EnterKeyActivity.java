...
public class EnterKeyActivity extends WizardPageActivity<Serializable> implements TextWatcher {
  ...
  public void onCreate(Bundle savedInstanceState) {
    ...
    mDigits = (Spinner) findViewById(R.id.digits_choice);
    ...
    ArrayAdapter<CharSequence> digitsList = ArrayAdapter.createFromResource(this,
        R.array.digits, android.R.layout.simple_spinner_item);
    digitsList.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
    mDigits.setAdapter(digitsList);
  ...
  protected void onRightButtonPressed() {
    ...
    OtpType mode = mType.getSelectedItemPosition() == OtpType.TOTP.value ?
                   OtpType.TOTP :
                   OtpType.HOTP;
    Integer digits = Integer.parseInt(mDigits.getSelectedItem() + "");
