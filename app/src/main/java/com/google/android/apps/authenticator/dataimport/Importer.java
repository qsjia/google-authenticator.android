...
public class Importer {
  ...
  // @VisibleForTesting
  static final String KEY_DIGITS = "digits";
  ...
  private void importAccountDbFromBundle(Bundle bundle, AccountDb accountDb) {
    ...
    for (String accountBundleKey : sortedAccountBundleKeys) {
      ...
      Integer digits = accountBundle.containsKey(KEY_DIGITS) ? accountBundle.getInt(KEY_DIGITS) : null;
      ...
      accountDb.update(name, encodedSecret, name, type, digits, counter);
